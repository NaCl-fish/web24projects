...
parser.add_argument('--img', type=str, default='ControlNet/image/bird/Unknown.jpeg', help='Image path')
parser.add_argument('--prompt', type=str, default='a bird with red eyes, ', help='Text prompt')


args = parser.parse_args()

input_image = np.array(c(Image.open(args.img)))
print(input_image.shape)
prompt = args.prompt
a_prompt = 'best quality, extremely detailed, red petals'
